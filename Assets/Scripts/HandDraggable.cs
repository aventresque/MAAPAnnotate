...
namespace HoloToolkit.Unity.InputModule
{
                                 ...
                                 ISourceStateHandler
    {
        ...
        [Tooltip("Objects you want to hide while dragging the target object")]
        public GameObject[] objectsToHide;

        public bool IsDraggingEnabled = true;

        private HandRotate scriptHandRotate;
        ...
        public void SetDragging(bool isEnabled)
        {
            ...
            {
                //stop rotation
                scriptHandRotate.enabled = false;
            }
        ...
        private void UpdateDragging()
        {
            ...
            else if (RotationMode == RotationModeEnum.Default)
            {
